...
public class FaxianPageFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.faxian_main,container,false);
        return view;
    }
    ...
    private void initViews() {
        textView = getView().findViewById(R.id.show_getAddress);
        mCallButton = getView().findViewById(R.id.police);
        btn_daohang = getView().findViewById(R.id.btn_daohang);
    }
